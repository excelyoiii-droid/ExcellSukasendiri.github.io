...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 51, 212, 91),
        centerTitle: true,
        title: const Text(
          'Poliwangi',
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: const Color.fromARGB(255, 51, 212, 91),
                    width: 3,
                  ),
                ),
                child: const Icon(
                  ...
                  size: 52,
                  color:  Color.fromARGB(255, 51, 212, 91),
                ),
              ),
              const SizedBox(height: 16),
              const Text(
                'Excell Ghandy Eko Prasetyo',
                style: TextStyle(
                  fontSize: 22,
                  ...
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        ...
                        backgroundColor:  Color.fromARGB(255, 51, 212, 91),
